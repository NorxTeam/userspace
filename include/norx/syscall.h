...
#define NORX_SPAWN2_SUPPORTED_FLAGS \
    (NORX_SPAWN_NEW_PROCESS_GROUP | NORX_SPAWN_FOREGROUND | \
     NORX_SPAWN_INHERIT_CREDENTIALS | NORX_SPAWN_INHERIT_OPEN_FDS)
#define NORX_SPAWN_MAX_PATH 256u
#define NORX_SPAWN_MAX_ARGUMENTS 16u
#define NORX_SPAWN_MAX_ENVIRONMENT 16u
#define NORX_SPAWN_MAX_STRING_BYTES 255u
#define NORX_SPAWN_STRING_SCAN_BYTES 256u
